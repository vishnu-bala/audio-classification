...
class BaseReader(object):
    """
    Inherit from this class when implementing a new reader.
    """
...
class YT8MAggregatedFeatureReader(BaseReader):
    ...
    def __init__(self,
                 ...
                 feature_names=None):
        """
        Constructs a YT8MAggregatedFeatureReader.
    ...
    def prepare_reader(self, filename_queue, batch_size=1024):
        ...
        Args:
          :param filename_queue: A tensorflow queue of filename locations.
    ...
    def prepare_serialized_examples(self, serialized_examples):
        ...
        concatenated_features = tf.concat([features[feature_name] for feature_name in self.feature_names], 1)
...
class YT8MFrameFeatureReader(BaseReader):
    ...
    def __init__(self,
                 ...
                 max_frames=300):
        """
        Constructs a YT8MFrameFeatureReader.
